...
[[Demonstration](https://bl.ocks.org/kkdd/92a185b33e387aa1de19cbce2ba7464f)]: The two of the following result rectangles (blue) cross on the antimeridian. The querying rectangle ```boudingRect``` (green) also crosses on the antimeridian.
